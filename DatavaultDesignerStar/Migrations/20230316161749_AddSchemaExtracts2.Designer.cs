...
namespace DatavaultDesignerStar.Migrations
{
    ...
    [Migration("20230316161749_AddSchemaExtracts2")]
    partial class AddSchemaExtracts2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatavaultDesignerStar.Models.AdfConfig.AdfConfigExtract", b =>
                {
                    b.Property<int>("AdfConfigExtractId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdfConfigExtractId"));

                    b.Property<string>("ExtractSource")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("AdfConfigExtractId");

                    b.ToTable("AdfConfigExtracts", "adfc");
                });
            ...
            modelBuilder.Entity("DatavaultDesignerStar.Models.AdfConfig.SchemaExtract", b =>
                {
                    b.Property<int>("SchemaExtractId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SchemaExtractId"));
                    ...
                    b.HasKey("SchemaExtractId");

                    b.HasIndex("ParentId");

                    b.ToTable("SchemaExtracts", "adfc");
                });
            ...
            modelBuilder.Entity("DatavaultDesignerStar.Models.AdfConfig.SchemaExtract", b =>
                {
                    b.HasOne("DatavaultDesignerStar.Models.AdfConfig.SchemaExtract", "Parent")
                        .WithMany("Children")
