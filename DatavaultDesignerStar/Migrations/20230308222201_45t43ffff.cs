...
{
    /// <inheritdoc />
    public partial class _45t43ffff : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReleaseTblColId = table.Column<int>(type: "int", nullable: false)
                    ...
                    ColTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReleaseTblCols", x => x.ReleaseTblColId);
                    table.ForeignKey(
                        name: "fk_ReleaseTblCols_Releases",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReleaseTblCols_ReleaseId",
                schema: "meta",
                table: "ReleaseTblCols",
                column: "ReleaseId");

            migrationBuilder.CreateIndex(
                name: "IX_ReleaseTblCols_TblId",
                schema: "meta",
                table: "ReleaseTblCols",
                column: "TblId");
        }
